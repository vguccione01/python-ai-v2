...
@router.post(
    ...
    responses={
        200: {"description": "OK", "content": {"application/json": {"example": ChatResponse(
            session_id="string",
            reply="string",
            tokens_used=10,
            cost_eur=0.0001,
        ...
        422: {"description": "Unprocessable Entity", "content": {"application/json": {"example": ErrorResponse(
            ...
            path="/api/ai/chat",
            details=[
                "session_id=Input should be a valid string"
            ]
        )}}},
